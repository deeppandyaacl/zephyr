...
class BluetoothConsole( TerminalNotebook, BluetoothConnection):
    ...
    def __init__(self):
        ...
        TerminalNotebook.__init__(self, self.write_bluetooth, vbox, self.unconnected_from_menu, self.display_message)
        ...
        self.update_interval = 0.1  # Update interval in seconds (e.g., 100 ms)
        self.running = True
    ...
    def unconnected_from_menu(self, device):
    ...
    def disconnect(self, device):
        ...
        self.remove_terminal(device)
        self.display_message("Disconnected from " + device)
