...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_DEVICE_NAME_MAX, 7);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADVERTISE_MANUFACTURER_ID, 65535);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADVERTISE_VERSION, 7);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_ANNE_ARIA_CPUNET, 1);
